...
## Output frequency ##
out_freq = 0.2      # frequency at which to output results to file (s)
...
right.mark(facets, 2)   # mark right boundary with label 2
...
F_T = (dt*kr*dot(grad(w),grad(T)) + rho*Cp*w*T - rho*Cp*w*T_n - rho*Hr*w*alpha_ + rho*Hr*w*alpha_n)*dx
...
# Output file
file_results = XDMFFile("results_1D_DCPD.xdmf")
